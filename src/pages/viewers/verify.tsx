      ...
      {verificationResult && (
        <Card title="Document Information" className="mb-4">
          <Descriptions bordered>
            ...
            <Descriptions.Item label="Hash">{verificationResult.hash}</Descriptions.Item>
            <Descriptions.Item label="Block">{verificationResult.block}</Descriptions.Item>
          </Descriptions>
        </Card>
      )}
      ...
      {verificationResult?.status === "error" && (
        <Alert
          ...
          description={
            ...
            "This file could not be verified. It may have been tampered with or was not registered."
          }
          type="error"
          showIcon
        />
